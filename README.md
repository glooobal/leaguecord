<h1 align="center">
    <br>
    <a href="https://discord.com/api/oauth2/authorize?client_id=1071897662657400842&permissions=314432&scope=bot%20applications.commands">
...
<p align="center">
    <a href="https://discord.com/api/oauth2/authorize?client_id=1071897662657400842&permissions=314432&scope=applications.commands%20bot">
        <img src="https://img.shields.io/badge/Invite-Me-7289da?style=for-the-badge" alt="Invite Me">
    </a>
    <img src="https://img.shields.io/codefactor/grade/github/glooobal/leaguecord?color=ba0872&style=for-the-badge">
    ...
    <img src="https://img.shields.io/github/package-json/v/glooobal/leaguecord?color=ba0872&style=for-the-badge">
    <a href="https://discord.gg/pQ7hg7aBeh">
...
-   `/vote` - Get link to Leaguecord vote page
...
- Go to https://developer.riotgames.com/, grab your API key and fill in the RIOT_API_KEY
...
4. Build the bot using `npm run build`
5. Run the bot using `npm start` :tada:

## Notes

-   If you find any bugs, please report them in the: [Support Server](https://discord.gg/pQ7hg7aBeh)
-   If you have any suggestions, please write them in the: [Support Server](https://discord.gg/pQ7hg7aBeh)
...
-   If you want to support me, you can invite Leaguecord to your server using [This Link](https://discord.com/api/oauth2/authorize?client_id=1071897662657400842&permissions=314432&scope=applications.commands%20bot)
...
This project is licensed under the terms of the [GPL-3.0](https://github.com/glooobal/leaguecord/blob/main/LICENSE) See the [LICENSE](https://raw.githubusercontent.com/glooobal/leaguecord/new/LICENSE) file for more info.
